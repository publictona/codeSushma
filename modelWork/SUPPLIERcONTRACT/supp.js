...
const controller = require('../controllers/loadContractSupplierController.js');
...
router.get('/master', (req, res, next) => {
    try {
        res.render('loadContractSupplier/list', {
...
router.get('/supplier/:supplier',function(req, res) {
    controller.supplier(req, res);
});
