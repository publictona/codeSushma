...
module.exports = {
    ...
    shipmentMasterDocument: async function(req, res){
        try {
            var {tranNo,ship_date,ship_time,ship_idNo,ship_brn ,ship_toname ,ship_toaddress , ship_tocity,ship_topincode , ship_tomobile,ship_content ,ship_printnos ,ship_fromname ,ship_time ,ship_fromaddress ,ship_fromcity,ship_frompincode,ship_remarks,srNo} = req.body;
            ...
            if(result){
                ...
                // console.log(req.body);
                shipmentSchema.findOne({},{},{sort:{tranNo:-1}},async function (err,dataTran){
